...
from sklearn.metrics import balanced_accuracy_score, f1_score, cohen_kappa_score, classification_report, roc_auc_score, average_precision_score, precision_score, recall_score
...
def evaluate_classifier(y_true, y_probs, print_report=False, plot=True):
    """
...
def evaluate_wrapper(method, y_pred_dict, dataset, surv_event_var = None, surv_time_var = None):
    ...
    """
    print("⚠️ Warning: All outcome variables are forcibly treated as categorical during evaluation.")
    metrics_list = []
