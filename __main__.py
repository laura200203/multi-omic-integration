...
def main():
    ...
    filename = f"{args.prefix}_final_model.pth"
    save_path = os.path.join(r"C:\Users\laura\OneDrive - Imperial College London\project 2\Coding\New models\package\flexynesis\flexynesis\models\model parameters", filename)
